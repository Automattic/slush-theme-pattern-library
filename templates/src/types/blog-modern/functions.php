...
function <%= appNameVar %>_setup() {
	 ...
	 * If you're building a theme based on <%= appNameSlug %>, use a find and replace
...
function <%= appNameVar %>_scripts() {
	...
	wp_enqueue_script( '<%= appNameSlug %>', get_template_directory_uri() . '/assets/js/thememodern.js', array(), '20120206', true );
