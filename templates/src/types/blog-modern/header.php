...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<?php if ( is_active_sidebar( 'sidebar-1' ) || has_nav_menu( 'main' ) || has_nav_menu ( 'social' ) ) : ?>
			<button class="menu-toggle animated" aria-expanded="false" ><span class="screen-reader-text"><?php _e( 'Show', '<%= appNameVar %>' ); ?></span><span class="action-text"><?php _e( 'Show', '<%= appNameVar %>' ); ?></span></button>
